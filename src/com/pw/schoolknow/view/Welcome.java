...
public class Welcome extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(System.currentTimeMillis()<TimeUtil.createtimesamp(2014, 6, 3, 0, 0)){
			logo.setVisibility(View.GONE);
			appName.setVisibility(View.GONE);
			layout.setBackgroundResource(R.drawable.loading2);
		}else if(System.currentTimeMillis()<TimeUtil.createtimesamp(2014, 8, 3, 0, 0)){
			logo.setVisibility(View.GONE);
			appName.setVisibility(View.GONE);
