...
public class Jwc extends BaseActivity {
	...
	private Object[][] fun={{"成绩查询",R.drawable.demo},{"考试安排",R.drawable.demo},{"网上评教",R.drawable.demo},
	{"网上选修",R.drawable.demo},{"空教室查询",R.drawable.demo},{"四六级查询",R.drawable.demo},
	{"补考安排",R.drawable.demo},{"第二课堂学分查询",R.drawable.demo},
	{"班级名单",R.drawable.demo},{"图书馆查询",R.drawable.demo},{"校友查询",R.drawable.demo}};
